...
<script type="text/javascript" src="jquery/bootstrap-datetimepicker-master/locale/bootstrap-datetimepicker.zh-CN.js"></script>
	...
	$(function(){
		...
		/* 
			...
			语法:
				$(需要绑定元素的有效的外层元素).on(绑定事件的元素的jquery对象，回调函数)
		 */
	...
	/*
		...
		pageList方法: 就是发去ajax请求到后台，从后台取得最新的市场活动信息列表数据
		...
		以上为pageList方法制定了六个入口，也就是说，在以上6个操作执行完毕之后，我们必须要调用pageList方法，刷新市场活动信息列表
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form id="activityAddForm" class="form-horizontal" role="form">
						...
						<div class="form-group">
							<label for="create-startTime" class="col-sm-2 control-label">所有者<span style="font-size: 15px; color: red;">*</span></label>
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-owner"></select>
							</div>
                            <label for="create-startTime" class="col-sm-2 control-label">名称<span style="font-size: 15px; color: red;">*</span></label>
                            <div class="col-sm-10" style="width: 300px;">
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 5px;">
				<div class="btn-group" style="position: relative; top: 18%;">
					<!--
						...
						但是这样做是有问题的:
							问题在于没有办法对按钮的功能进行扩充
						所以未来实际项目开发，对于触发模态窗口的操作，一定不要写死的模态窗口中
						应该有我们自己写js代码来操作	
